...
$n = count($this->items);
?>
<form action="<?php echo JRoute::_('index.php?option=com_ztmap&view=sitemaps'); ?>" method="post" name="adminForm">
                ...
                <tr class="row<?php echo $i % 2; ?>">
                    <td>
                        <a style="cursor: pointer;" onclick="if (window.parent)
                                        window.parent.<?php echo $function; ?>('<?php echo $item->id; ?>', '<?php echo $this->escape($item->title); ?>');">
