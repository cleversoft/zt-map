 ...
 */
class ZtmapModelSitemap extends JModelAdmin
{

    protected $_context = 'com_ztmap';
    ...
    protected function _populateState()
    {
        ...
        // Load the parameters.
        $params = JComponentHelper::getParams('com_ztmap');
     ...
     * @return   ZtmapTableSitemap    A database object
     */
    public function getTable($type = 'Sitemap', $prefix = 'ZtmapTable', $config = array())
    {
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_ztmap.sitemap', 'sitemap', array('control' => 'jform', 'load_data' => $loadData));
        if (empty($form))
        {
            return false;
        }
    ...
    protected function loadFormData()
    {
        ...
        $data = JFactory::getApplication()->getUserState('com_ztmap.edit.sitemap.data', array());
    ...
    public function save($data)
    {
        ...
        if ($table->is_default)
        {
            $query = $this->_db->getQuery(true)
                    ->update($this->_db->quoteName('#__ztmap_sitemap'))
        ...
        // Clean the cache.
        $cache = JFactory::getCache('com_ztmap');
        $cache->clean();
    ...
    function setDefault($id)
    {
        ...
        if ($table->load($id))
        {
            ...
            $query = $db->getQuery(true)
                    ->update($db->quoteName('#__ztmap_sitemap'))
