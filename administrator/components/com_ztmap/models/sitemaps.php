 ...
 * @since           0.0.5
 */
class ZtmapModelSitemaps extends JModelList
{
    ...
    public function getExtensionsMessage()
    {
        ...
        $query->join('INNER', '#__extensions AS p ON e.element=p.element and p.enabled=0 and p.type=\'plugin\' and p.folder=\'ztmap\'');
        ...
        if (count($extensions))
        {
            ...
            return JText::sprintf('ZTMAP_MESSAGE_EXTENSIONS_DISABLED', $extensionsNameList);
        } else
        {
            return "";
        }
