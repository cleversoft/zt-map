...
class ztmap_com_sobipro
{
    ...
    function getTree($ztmap, $parent, &$params)
    {
        ...
        $include_entries = ( $include_entries == 1 || ( $include_entries == 2 && $ztmap->view == 'xml') || ( $include_entries == 3 && $ztmap->view == 'html') || $ztmap->view == 'navigator');
        ...
        if ($include_entries)
        {
            ...
            if (intval($days))
                $params['days'] = ' AND a.publish_up >=\'' . strftime("%Y-%m-%d %H:%M:%S", $ztmap->now - ($days * 86400)) . "' ";
        }

        ztmap_com_sobipro::getCategoryTree($ztmap, $parent, $sid, $params);
    }

    /** SobiPro support */
    function getCategoryTree($ztmap, $parent, $sid, &$params)
    {
        ...
        foreach ($rows as $row)
        {
            ...
            {
                ztmap_com_sobipro::getCategoryTree($ztmap, $parent, $row->id, $params);
            }
        }
