...
class ztmap_com_virtuemart
{
    ...
    static function getTree($ztmap, $parent, &$params)
    {
        ...
        $include_products = ( $include_products == 1 || ( $include_products == 2 && $ztmap->view == 'xml') || ( $include_products == 3 && $ztmap->view == 'html'));

        $params['include_products'] = $include_products;
        $params['include_product_images'] = (JArrayHelper::getValue($params, 'include_product_images', 1) && $ztmap->view == 'xml');
        ...
        ztmap_com_virtuemart::getCategoryTree($ztmap, $parent, $params, $catid);

        return true;
    }

    /** Virtuemart support */
    static function getCategoryTree($ztmap, $parent, &$params, $catid = 0)
    {
        ...
        foreach ($children as $row)
        {
            ...
            {
                ztmap_com_virtuemart::getCategoryTree($ztmap, $parent, $params, $row->virtuemart_category_id);
            }
        }
