...
if (($this->item->params->get('beautify_xml', 1) == 1) && !$this->displayer->isNews)
{
    ...
    echo '<?xml-stylesheet type="text/xsl" href="' . $live_site . '/index.php?option=com_ztmap&amp;view=xml&amp;layout=xsl&amp;tmpl=component&amp;id=' . $this->item->id . ($this->isImages ? '&amp;images=1' : '') . $params . '"?>' . "\n";
}
?>
