...
class ZtmapRoute
{
    ...
    public static function sitemap($id, $view = 'html')
    {
        ...
        //Create the link
        $link = 'index.php?option=com_ztmap&view=' . $view . '&id=' . $id;
    ...
    protected static function _findItemId($needles)
    {
        ...
        if (self::$lookup === null)
        {
            ...
            $component = &JComponentHelper::getComponent('com_ztmap');
 ...
 */
function ZtmapBuildRoute(&$query)
{
    $segments = array();
 ...
 */
function ZtmapParseRoute($segments)
{
    $vars = array();
