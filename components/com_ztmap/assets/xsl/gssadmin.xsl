...
<style type="text/css">
    ...
    .editable {
        cursor:pointer;
        background: url(components/com_ztmap/images/arrow.gif) top right no-repeat;
        padding-right:18px;
        padding-right:18px;
        border:1px solid #ffffff;
    }
...
<script language="JavaScript">
    ...
    function changeProperty(el,property) {
        var myAjax = new Ajax('index.php?option=com_ztmap&tmpl=component&task=editElement&action=changeProperty&sitemap='+sitemapid+'&uid='+divOptions.uid+'&itemid='+divOptions.itemid+'&property='+property+'&value='+el.innerHTML,{
